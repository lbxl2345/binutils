...
prefix = /home/lbx/binutils-build
exec_prefix = ${prefix}
...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --prefix=/home/lbx/binutils-build/ --enable-shared
...
BUILD_CONFIGARGS =  --cache-file=./config.cache '--prefix=/home/lbx/binutils-build/' '--enable-shared' --program-transform-name='s,y,y,' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-gnu-as --with-gnu-ld '--prefix=/home/lbx/binutils-build/' '--enable-shared' --program-transform-name='s,y,y,' --disable-option-checking
...
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib   '--prefix=/home/lbx/binutils-build/' '--enable-shared' --program-transform-name='s,y,y,' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
configure-zlib: 
	...
	$(SHELL) \
	  ...
	  --srcdir=$${topdir}/$$module_srcdir \
	  $(HOST_CONFIGARGS) --build=${build_alias} --host=${host_alias} \
	  --target=${target_alias} --enable-host-shared \
	  || exit 1
